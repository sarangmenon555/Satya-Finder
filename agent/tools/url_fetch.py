# This Script contains the function fetch_url
# This Function is registered as a tool with langchain
# This tool allows the model to enter a url and get all info including text about that url
...
# Define the function that is used as the tool
@tool
def fetch_url(url: str) -> str:
    ...
    try:
        ...
        for tag in scraper(["nav", "footer", "script", "style"]):
            tag.decompose()
        text = scraper.get_text(seperator=" ", strip=True)
