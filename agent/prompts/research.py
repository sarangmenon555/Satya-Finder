...
verdict, response, confidence must all be null, with sources as an empty list.

When status is "failed": verdict, response, confidence, and question must all
be null, with sources as an empty list.
